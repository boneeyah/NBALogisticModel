...
Also added FG% and FT% based on domain knowledge of efficiency

```{r}
custom.mod <- glm(WINorLOSS~ Home + PTS + FGA + `FG%` + `3PA` + `3P%` + FTA + `FT%` + TRB + AST + STL + BLK + TOV + PF, family = "binomial", data = train)
summary(custom.mod)
